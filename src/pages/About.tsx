    ...
    <main className="bg-background">
      <section className="relative overflow-hidden bg-secondary px-4 pb-24 pt-40 text-white">
        <div className="container relative z-10 max-w-6xl">
          <p className="mb-5 text-xs uppercase tracking-[0.35em] text-primary">ImobiSpace Home</p>
          ...
          <p className="mt-8 max-w-2xl text-lg font-light leading-relaxed text-white/65">Uma imobiliária construída para crescer, com relacionamento, reputação e uma experiência que merece ser indicada.</p>
        </div>
      </section>
